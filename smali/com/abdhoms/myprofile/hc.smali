.class Lcom/abdhoms/myprofile/hc;
...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V
    ...
    iput-object v0, p0, Lcom/abdhoms/myprofile/hc;->f:Ljava/util/ArrayList;

    new-instance v0, Lcom/abdhoms/myprofile/hd;

    invoke-direct {v0, p0}, Lcom/abdhoms/myprofile/hd;-><init>(Lcom/abdhoms/myprofile/hc;)V

    iput-object v0, p0, Lcom/abdhoms/myprofile/hc;->h:Ljava/lang/Runnable;

    new-instance v0, Lcom/abdhoms/myprofile/he;

    invoke-direct {v0, p0}, Lcom/abdhoms/myprofile/he;-><init>(Lcom/abdhoms/myprofile/hc;)V

    iput-object v0, p0, Lcom/abdhoms/myprofile/hc;->i:Landroid/support/v7/widget/gn;
    ...
    iput-object v0, p0, Lcom/abdhoms/myprofile/hc;->a:Landroid/support/v7/widget/bz;

    new-instance v0, Lcom/abdhoms/myprofile/hi;

    invoke-direct {v0, p0, p3}, Lcom/abdhoms/myprofile/hi;-><init>(Lcom/abdhoms/myprofile/hc;Landroid/view/Window$Callback;)V

    iput-object v0, p0, Lcom/abdhoms/myprofile/hc;->c:Landroid/view/Window$Callback;

    iget-object v0, p0, Lcom/abdhoms/myprofile/hc;->a:Landroid/support/v7/widget/bz;

    iget-object v1, p0, Lcom/abdhoms/myprofile/hc;->c:Landroid/view/Window$Callback;

    invoke-interface {v0, v1}, Landroid/support/v7/widget/bz;->a(Landroid/view/Window$Callback;)V

    iget-object v0, p0, Lcom/abdhoms/myprofile/hc;->i:Landroid/support/v7/widget/gn;
...
.method private a(Landroid/view/Menu;)Landroid/view/View;
    ...
    invoke-direct {p0, p1}, Lcom/abdhoms/myprofile/hc;->b(Landroid/view/Menu;)V

    if-eqz p1, :cond_0

    iget-object v1, p0, Lcom/abdhoms/myprofile/hc;->g:Landroid/support/v7/view/menu/g;
    ...
    iget-object v0, p0, Lcom/abdhoms/myprofile/hc;->g:Landroid/support/v7/view/menu/g;

    iget-object v1, p0, Lcom/abdhoms/myprofile/hc;->a:Landroid/support/v7/widget/bz;
...
.method static synthetic a(Lcom/abdhoms/myprofile/hc;Landroid/view/Menu;)Landroid/view/View;
    .locals 1

    invoke-direct {p0, p1}, Lcom/abdhoms/myprofile/hc;->a(Landroid/view/Menu;)Landroid/view/View;
...
.method static synthetic a(Lcom/abdhoms/myprofile/hc;)Landroid/view/Window$Callback;
    .locals 1

    iget-object v0, p0, Lcom/abdhoms/myprofile/hc;->c:Landroid/view/Window$Callback;

    return-object v0
.end method

.method static synthetic a(Lcom/abdhoms/myprofile/hc;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/abdhoms/myprofile/hc;->b:Z
...
.method private b(Landroid/view/Menu;)V
    ...
    sget v3, Lcom/abdhoms/myprofile/hp;->actionBarPopupTheme:I
    ...
    :cond_0
    sget v3, Lcom/abdhoms/myprofile/hp;->panelMenuListTheme:I
    ...
    sget v2, Lcom/abdhoms/myprofile/hw;->abc_list_menu_item_layout:I

    invoke-direct {v0, v1, v2}, Landroid/support/v7/view/menu/g;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Lcom/abdhoms/myprofile/hc;->g:Landroid/support/v7/view/menu/g;

    iget-object v0, p0, Lcom/abdhoms/myprofile/hc;->g:Landroid/support/v7/view/menu/g;

    new-instance v1, Lcom/abdhoms/myprofile/hh;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/abdhoms/myprofile/hh;-><init>(Lcom/abdhoms/myprofile/hc;Lcom/abdhoms/myprofile/hd;)V
    ...
    :cond_2
    sget v1, Lcom/abdhoms/myprofile/hy;->Theme_AppCompat_CompactMenu:I
...
.method static synthetic b(Lcom/abdhoms/myprofile/hc;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/abdhoms/myprofile/hc;->b:Z

    return v0
.end method

.method static synthetic c(Lcom/abdhoms/myprofile/hc;)Landroid/support/v7/widget/bz;
    .locals 1
...
.method private g()Landroid/view/Menu;
    ...
    iget-boolean v0, p0, Lcom/abdhoms/myprofile/hc;->d:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/abdhoms/myprofile/hc;->a:Landroid/support/v7/widget/bz;

    new-instance v1, Lcom/abdhoms/myprofile/hf;

    invoke-direct {v1, p0, v3}, Lcom/abdhoms/myprofile/hf;-><init>(Lcom/abdhoms/myprofile/hc;Lcom/abdhoms/myprofile/hd;)V

    new-instance v2, Lcom/abdhoms/myprofile/hg;

    invoke-direct {v2, p0, v3}, Lcom/abdhoms/myprofile/hg;-><init>(Lcom/abdhoms/myprofile/hc;Lcom/abdhoms/myprofile/hd;)V
    ...
    iput-boolean v0, p0, Lcom/abdhoms/myprofile/hc;->d:Z
...
.method public a(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Lcom/abdhoms/myprofile/et;->a(Landroid/content/res/Configuration;)V
...
.method public a(Z)V
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Lcom/abdhoms/myprofile/hc;->a(II)V
...
.method public a(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0}, Lcom/abdhoms/myprofile/hc;->g()Landroid/view/Menu;
...
.method public c()Z
    ...
    iget-object v1, p0, Lcom/abdhoms/myprofile/hc;->h:Ljava/lang/Runnable;
...
.method public f(Z)V
    ...
    iget-boolean v0, p0, Lcom/abdhoms/myprofile/hc;->e:Z
    ...
    :cond_1
    iput-boolean p1, p0, Lcom/abdhoms/myprofile/hc;->e:Z

    iget-object v0, p0, Lcom/abdhoms/myprofile/hc;->f:Ljava/util/ArrayList;
