...
# instance fields
.field private d:Landroid/support/v7/widget/gf;
...
.field private j:Landroid/support/v7/widget/bg;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v7/widget/bd;->a:Z
    ...
    :goto_1
    sput-boolean v0, Landroid/support/v7/widget/bd;->b:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-virtual {v4}, Landroid/support/v7/widget/gh;->b()Landroid/support/v7/widget/gf;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/bd;->d:Landroid/support/v7/widget/gf;

    new-instance v0, Landroid/support/v7/widget/am;

    iget-object v2, p0, Landroid/support/v7/widget/bd;->d:Landroid/support/v7/widget/gf;

    invoke-direct {v0, p0, v2}, Landroid/support/v7/widget/am;-><init>(Landroid/view/View;Landroid/support/v7/widget/gf;)V

    iput-object v0, p0, Landroid/support/v7/widget/bd;->e:Landroid/support/v7/widget/am;
    ...
    :goto_0
    iget-object v0, p0, Landroid/support/v7/widget/bd;->f:Landroid/content/Context;
    ...
    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/gh;->f(II)I
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/bg;->a(Ljava/lang/CharSequence;)V

    invoke-virtual {v2}, Landroid/support/v7/widget/gh;->a()V

    iput-object v0, p0, Landroid/support/v7/widget/bd;->j:Landroid/support/v7/widget/bg;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/bd;->g:Landroid/support/v7/widget/cz;

    :cond_2
    invoke-virtual {v4}, Landroid/support/v7/widget/gh;->a()V

    iput-boolean v3, p0, Landroid/support/v7/widget/bd;->i:Z

    iget-object v0, p0, Landroid/support/v7/widget/bd;->h:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/bd;->h:Landroid/widget/SpinnerAdapter;

    :cond_3
    iget-object v0, p0, Landroid/support/v7/widget/bd;->e:Landroid/support/v7/widget/am;
...
.method static synthetic a(Landroid/support/v7/widget/bd;Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    .locals 1

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/bd;->a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
...
.method private a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bd;->l:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bd;->l:Landroid/graphics/Rect;
...
.method static synthetic a(Landroid/support/v7/widget/bd;)Landroid/support/v7/widget/bg;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/bd;->j:Landroid/support/v7/widget/bg;
...
.method static synthetic b(Landroid/support/v7/widget/bd;)Landroid/graphics/Rect;
    .locals 1
...
.method static synthetic c(Landroid/support/v7/widget/bd;)I
    .locals 1
...
.method public getDropDownHorizontalOffset()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/bg;->f()I
    ...
    :cond_0
    sget-boolean v0, Landroid/support/v7/widget/bd;->b:Z
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/bg;->g()I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/bg;->d()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/bg;->a()Ljava/lang/CharSequence;
...
.method protected onMeasure(II)V
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/v7/widget/bd;->a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bd;->g:Landroid/support/v7/widget/cz;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/bd;->h:Landroid/widget/SpinnerAdapter;
    ...
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/bd;->j:Landroid/support/v7/widget/bg;
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/bg;->b(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/bg;->c(I)V
...
.method public setDropDownWidth(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/bd;->k:I
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/bg;->a(Ljava/lang/CharSequence;)V
