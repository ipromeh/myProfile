...
.method constructor <init>(Landroid/support/v7/widget/LinearLayoutManager;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/cq;->d:Landroid/support/v7/widget/LinearLayoutManager;
...
.method static synthetic a(Landroid/support/v7/widget/cq;Landroid/view/View;Landroid/support/v7/widget/eq;)Z
    .locals 1

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/cq;->a(Landroid/view/View;Landroid/support/v7/widget/eq;)Z
...
.method private a(Landroid/view/View;Landroid/support/v7/widget/eq;)Z
    .locals 2
...
.method public a(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/cq;->d:Landroid/support/v7/widget/LinearLayoutManager;

    iget-object v0, v0, Landroid/support/v7/widget/LinearLayoutManager;->b:Landroid/support/v7/widget/dl;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/cq;->b(Landroid/view/View;)V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/cq;->d:Landroid/support/v7/widget/LinearLayoutManager;
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/cq;->c:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v7/widget/cq;->d:Landroid/support/v7/widget/LinearLayoutManager;

    iget-object v1, v1, Landroid/support/v7/widget/LinearLayoutManager;->b:Landroid/support/v7/widget/dl;
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/dl;->c(Landroid/view/View;)I

    move-result v1

    iget v2, p0, Landroid/support/v7/widget/cq;->b:I

    sub-int v1, v2, v1

    iget-object v2, p0, Landroid/support/v7/widget/cq;->d:Landroid/support/v7/widget/LinearLayoutManager;

    iget-object v2, v2, Landroid/support/v7/widget/LinearLayoutManager;->b:Landroid/support/v7/widget/dl;

    invoke-virtual {v2}, Landroid/support/v7/widget/dl;->c()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/widget/cq;->d:Landroid/support/v7/widget/LinearLayoutManager;

    iget-object v3, v3, Landroid/support/v7/widget/LinearLayoutManager;->b:Landroid/support/v7/widget/dl;
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/dl;->c(Landroid/view/View;)I
...
.method public toString()Ljava/lang/String;
    ...
    iget v1, p0, Landroid/support/v7/widget/cq;->a:I
