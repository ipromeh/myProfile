...
.field static final HIDDEN_METHOD_INVOKER:Landroid/support/v7/widget/ft;
...
.field private mOnCloseListener:Landroid/support/v7/widget/fu;
...
.field private mOnQueryChangeListener:Landroid/support/v7/widget/fv;

.field private mOnQueryTextFocusChangeListener:Landroid/view/View$OnFocusChangeListener;

.field private mOnSearchClickListener:Landroid/view/View$OnClickListener;

.field private mOnSuggestionListener:Landroid/support/v7/widget/fw;
...
.field private mSuggestionsAdapter:Landroid/support/v4/widget/o;

.field mTextKeyListener:Landroid/view/View$OnKeyListener;

.field private mTextWatcher:Landroid/text/TextWatcher;

.field private final mTintManager:Landroid/support/v7/widget/gf;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Landroid/support/v7/widget/ft;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/co;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    new-instance v0, Landroid/support/v7/widget/fh;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/fh;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/fl;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/fm;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/fq;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/fr;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/fs;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/fi;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/fj;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/fk;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/gh;->b()Landroid/support/v7/widget/gf;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mTintManager:Landroid/support/v7/widget/gf;
    ...
    invoke-direct {v2, p0}, Landroid/support/v7/widget/fn;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method static synthetic access$100(Landroid/support/v7/widget/SearchView;)Landroid/support/v4/widget/o;
    .locals 1
...
.method private addOnLayoutChangeListenerToDropDownAnchorBase()V
    ...
    new-instance v1, Landroid/support/v7/widget/fp;

    invoke-direct {v1, p0}, Landroid/support/v7/widget/fp;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private addOnLayoutChangeListenerToDropDownAnchorSDK11()V
    ...
    new-instance v1, Landroid/support/v7/widget/fo;

    invoke-direct {v1, p0}, Landroid/support/v7/widget/fo;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/fy;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/fy;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private forceSuggestionQuery()V
    ...
    sget-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Landroid/support/v7/widget/ft;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ft;->a(Landroid/widget/AutoCompleteTextView;)V

    sget-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Landroid/support/v7/widget/ft;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ft;->b(Landroid/widget/AutoCompleteTextView;)V
...
.method private onCloseClicked()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Landroid/support/v7/widget/fu;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Landroid/support/v7/widget/fu;

    invoke-interface {v0}, Landroid/support/v7/widget/fu;->a()Z
...
.method private onItemClicked(IILjava/lang/String;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Landroid/support/v7/widget/fw;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Landroid/support/v7/widget/fw;

    invoke-interface {v1, p1}, Landroid/support/v7/widget/fw;->b(I)Z
...
.method private onItemSelected(I)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Landroid/support/v7/widget/fw;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Landroid/support/v7/widget/fw;

    invoke-interface {v0, p1}, Landroid/support/v7/widget/fw;->a(I)Z
...
.method private onSubmitQuery()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Landroid/support/v7/widget/fv;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/fv;->a(Ljava/lang/String;)Z
...
.method private onSuggestionsKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/ft;->a(Landroid/widget/AutoCompleteTextView;Z)V
...
.method private onTextChanged(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Landroid/support/v7/widget/fv;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/fv;->b(Ljava/lang/String;)Z
...
.method private rewriteQueryFromSuggestion(I)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/o;->a()Landroid/database/Cursor;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/o;->c(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Landroid/support/v7/widget/fy;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    :cond_2
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/fy;->a(I)V
...
.method public clearFocus()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/co;->clearFocus()V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/co;->onDetachedFromWindow()V
...
.method protected onMeasure(II)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/co;->onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Landroid/support/v7/widget/co;->onMeasure(II)V
...
.method public onWindowFocusChanged(Z)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/co;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    :cond_3
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/co;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setOnCloseListener(Landroid/support/v7/widget/fu;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Landroid/support/v7/widget/fu;
...
.method public setOnQueryTextListener(Landroid/support/v7/widget/fv;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Landroid/support/v7/widget/fv;
...
.method public setOnSuggestionListener(Landroid/support/v7/widget/fw;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Landroid/support/v7/widget/fw;
