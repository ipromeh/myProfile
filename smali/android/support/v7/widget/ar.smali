...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lcom/abdhoms/myprofile/hp;->editTextStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ar;->a:Landroid/support/v7/widget/gf;

    new-instance v0, Landroid/support/v7/widget/am;

    iget-object v1, p0, Landroid/support/v7/widget/ar;->a:Landroid/support/v7/widget/gf;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/am;-><init>(Landroid/view/View;Landroid/support/v7/widget/gf;)V

    iput-object v0, p0, Landroid/support/v7/widget/ar;->b:Landroid/support/v7/widget/am;

    iget-object v0, p0, Landroid/support/v7/widget/ar;->b:Landroid/support/v7/widget/am;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ar;->c:Landroid/support/v7/widget/bk;

    iget-object v0, p0, Landroid/support/v7/widget/ar;->c:Landroid/support/v7/widget/bk;
