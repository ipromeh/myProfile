...
.field private E:Landroid/support/v7/widget/gn;
...
.field private I:Landroid/support/v7/widget/gl;
...
.field private final N:Landroid/support/v7/widget/gf;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/gi;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/gh;->c(II)I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->N:Landroid/support/v7/widget/gf;
...
.method private a(Landroid/view/View;I)I
    ...
    :goto_0
    iget v4, v0, Landroid/support/v7/widget/gm;->a:I
    ...
    iget v7, v0, Landroid/support/v7/widget/gm;->topMargin:I

    if-ge v1, v7, :cond_1

    iget v0, v0, Landroid/support/v7/widget/gm;->topMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/gm;->bottomMargin:I
    ...
    iget v5, v0, Landroid/support/v7/widget/gm;->bottomMargin:I
...
.method private a(Landroid/view/View;I[II)I
    ...
    iget v1, v0, Landroid/support/v7/widget/gm;->leftMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/gm;->rightMargin:I
...
.method private a(Ljava/util/List;[I)I
    ...
    iget v8, v1, Landroid/support/v7/widget/gm;->leftMargin:I

    sub-int v6, v8, v6

    iget v1, v1, Landroid/support/v7/widget/gm;->rightMargin:I
...
.method static synthetic a(Landroid/support/v7/widget/Toolbar;)Landroid/support/v7/widget/gn;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->E:Landroid/support/v7/widget/gn;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/Toolbar;->i()Landroid/support/v7/widget/gm;
    ...
    iput v1, v0, Landroid/support/v7/widget/gm;->b:I
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/gm;
...
.method private a(Ljava/util/List;I)V
    ...
    iget v4, v0, Landroid/support/v7/widget/gm;->b:I
    ...
    iget v5, v0, Landroid/support/v7/widget/gm;->b:I
...
.method private b(Landroid/view/View;I[II)I
    ...
    iget v1, v0, Landroid/support/v7/widget/gm;->rightMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/gm;->leftMargin:I
...
.method private m()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/gl;
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v7/widget/gl;-><init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/gi;)V

    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/gl;
...
.method private p()V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/gk;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
# virtual methods
.method public a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/gm;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v7/widget/gm;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method protected a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/gm;
    .locals 1

    instance-of v0, p1, Landroid/support/v7/widget/gm;

    if-eqz v0, :cond_0

    new-instance v0, Landroid/support/v7/widget/gm;

    check-cast p1, Landroid/support/v7/widget/gm;

    invoke-direct {v0, p1}, Landroid/support/v7/widget/gm;-><init>(Landroid/support/v7/widget/gm;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/gm;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/gm;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public a(Landroid/support/v7/view/menu/i;Landroid/support/v7/widget/ActionMenuPresenter;)V
    .locals 4
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/gl;

    if-nez v0, :cond_3

    new-instance v0, Landroid/support/v7/widget/gl;

    invoke-direct {v0, p0, v3}, Landroid/support/v7/widget/gl;-><init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/gi;)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/gl;
    ...
    invoke-virtual {p2, v0, v3}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/content/Context;Landroid/support/v7/view/menu/i;)V

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/gl;

    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {v0, v1, v3}, Landroid/support/v7/widget/gl;->a(Landroid/content/Context;Landroid/support/v7/view/menu/i;)V

    invoke-virtual {p2, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Z)V

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/gl;

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/gl;->a(Z)V
...
.method public g()Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/gl;->b:Landroid/support/v7/view/menu/m;
...
.method public synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/gm;
...
.method protected synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/gm;
...
.method public getWrapper()Landroid/support/v7/widget/bz;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->G:Landroid/support/v7/widget/gp;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/gp;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->G:Landroid/support/v7/widget/gp;
...
.method protected i()Landroid/support/v7/widget/gm;
    .locals 2
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v7/widget/gm;-><init>(II)V
...
.method j()V
    ...
    iget v0, v0, Landroid/support/v7/widget/gm;->b:I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/bw;->p(Landroid/view/View;)I
    ...
    check-cast v3, Landroid/support/v7/widget/gm;

    iget v9, v3, Landroid/support/v7/widget/gm;->topMargin:I
    ...
    iget v3, v3, Landroid/support/v7/widget/gm;->bottomMargin:I
    ...
    check-cast v4, Landroid/support/v7/widget/gm;
    ...
    iget v0, v3, Landroid/support/v7/widget/gm;->topMargin:I
    ...
    iget v3, v3, Landroid/support/v7/widget/gm;->topMargin:I
    ...
    iget v5, v3, Landroid/support/v7/widget/gm;->topMargin:I
    ...
    iget v4, v4, Landroid/support/v7/widget/gm;->bottomMargin:I
    ...
    iget v10, v3, Landroid/support/v7/widget/gm;->topMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1}, Landroid/support/v4/view/bw;->j(Landroid/view/View;)I

    move-result v1

    invoke-static {v9, v1}, Landroid/support/v7/widget/gw;->a(II)I
    ...
    invoke-static {v0}, Landroid/support/v4/view/bw;->j(Landroid/view/View;)I

    move-result v0

    invoke-static {v9, v0}, Landroid/support/v7/widget/gw;->a(II)I
    ...
    invoke-static {v11, v0}, Landroid/support/v7/widget/gw;->a(II)I
    ...
    invoke-static {v11, v4}, Landroid/support/v7/widget/gw;->a(II)I
    ...
    invoke-static {v2}, Landroid/support/v4/view/bw;->j(Landroid/view/View;)I

    move-result v2

    invoke-static {v11, v2}, Landroid/support/v7/widget/gw;->a(II)I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/gl;->b:Landroid/support/v7/view/menu/m;
...
.method public setLogo(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->N:Landroid/support/v7/widget/gf;
...
.method public setOnMenuItemClickListener(Landroid/support/v7/widget/gn;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->E:Landroid/support/v7/widget/gn;
