...
.method public a(Landroid/support/v7/view/menu/i;Z)V
    ...
    :cond_1
    invoke-virtual {p0}, Landroid/support/v7/view/menu/v;->g()V
...
.method public a(Landroid/support/v7/view/menu/ad;)Z
    ...
    :goto_1
    invoke-virtual {v3, v0}, Landroid/support/v7/view/menu/v;->b(Z)V

    invoke-virtual {v3}, Landroid/support/v7/view/menu/v;->f()Z
...
.method public e()Landroid/support/v7/widget/cu;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cu;
...
.method public f()Z
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cu;

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cu;
    ...
    invoke-direct {p0}, Landroid/support/v7/view/menu/v;->i()I
...
.method public g()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/v;->h()Z
...
.method public onDismiss()V
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/cu;
