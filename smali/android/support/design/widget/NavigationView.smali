...
.field private final mMenu:Landroid/support/design/internal/b;

.field private mMenuInflater:Landroid/view/MenuInflater;

.field private final mPresenter:Landroid/support/design/internal/c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/design/internal/q;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    new-instance v0, Landroid/support/design/internal/c;

    invoke-direct {v0}, Landroid/support/design/internal/c;-><init>()V

    iput-object v0, p0, Landroid/support/design/widget/NavigationView;->mPresenter:Landroid/support/design/internal/c;
    ...
    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->mMenu:Landroid/support/design/internal/b;
    ...
    invoke-virtual {v8, v9}, Landroid/support/design/internal/b;->a(Landroid/support/v7/view/menu/j;)V

    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->mPresenter:Landroid/support/design/internal/c;

    invoke-virtual {v8, v4}, Landroid/support/design/internal/c;->a(I)V

    iget-object v4, p0, Landroid/support/design/widget/NavigationView;->mPresenter:Landroid/support/design/internal/c;

    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->mMenu:Landroid/support/design/internal/b;

    invoke-virtual {v4, p1, v8}, Landroid/support/design/internal/c;->a(Landroid/content/Context;Landroid/support/v7/view/menu/i;)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->mPresenter:Landroid/support/design/internal/c;
    ...
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->mMenu:Landroid/support/design/internal/b;

    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->mPresenter:Landroid/support/design/internal/c;

    invoke-virtual {v0, v1}, Landroid/support/design/internal/b;->a(Landroid/support/v7/view/menu/x;)V

    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->mPresenter:Landroid/support/design/internal/c;

    invoke-virtual {v0, p0}, Landroid/support/design/internal/c;->a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/z;
...
.method public inflateMenu(I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->mMenu:Landroid/support/design/internal/b;
...
.method protected onMeasure(II)V
    ...
    :goto_0
    :sswitch_0
    invoke-super {p0, p1, p2}, Landroid/support/design/internal/q;->onMeasure(II)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, v0}, Landroid/support/design/internal/q;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-super {p0}, Landroid/support/design/internal/q;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method public removeHeaderView(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/internal/c;->b(Landroid/view/View;)V
...
.method public setCheckedItem(I)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/design/internal/c;->a(Landroid/support/v7/view/menu/m;)V
