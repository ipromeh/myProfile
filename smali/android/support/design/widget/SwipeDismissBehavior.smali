...
.field private final mDragCallback:Landroid/support/v4/widget/cn;
...
.field private mViewDragHelper:Landroid/support/v4/widget/ck;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->mDragCallback:Landroid/support/v4/widget/cn;
...
.method static synthetic access$100(Landroid/support/design/widget/SwipeDismissBehavior;)Landroid/support/v4/widget/ck;
    .locals 1

    iget-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->mViewDragHelper:Landroid/support/v4/widget/ck;
...
.method private ensureViewDragHelper(Landroid/view/ViewGroup;)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/SwipeDismissBehavior;->mDragCallback:Landroid/support/v4/widget/cn;

    invoke-static {p1, v0, v1}, Landroid/support/v4/widget/ck;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/cn;)Landroid/support/v4/widget/ck;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->mViewDragHelper:Landroid/support/v4/widget/ck;

    :cond_0
    return-void

    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->mDragCallback:Landroid/support/v4/widget/cn;

    invoke-static {p1, v0}, Landroid/support/v4/widget/ck;->a(Landroid/view/ViewGroup;Landroid/support/v4/widget/cn;)Landroid/support/v4/widget/ck;
...
.method public getDragState()I
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/ck;->a()I
...
.method public onInterceptTouchEvent(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p3}, Landroid/support/v4/widget/ck;->a(Landroid/view/MotionEvent;)Z
...
.method public onTouchEvent(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p3}, Landroid/support/v4/widget/ck;->b(Landroid/view/MotionEvent;)V
