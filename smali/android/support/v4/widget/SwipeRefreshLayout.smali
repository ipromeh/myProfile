...
.field private C:Landroid/support/v4/widget/ap;
...
.field private e:Landroid/support/v4/widget/by;
...
.method private a(II)Landroid/view/animation/Animation;
    ...
    :cond_0
    new-instance v1, Landroid/support/v4/widget/bt;

    invoke-direct {v1, p0, p1, p2}, Landroid/support/v4/widget/bt;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;II)V
...
.method private a(F)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/ap;
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/ap;

    invoke-virtual {v1}, Landroid/support/v4/widget/ap;->getAlpha()I
    ...
    iget-object v4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/ap;

    invoke-static {v13, v1}, Ljava/lang/Math;->min(FF)F

    move-result v1

    invoke-virtual {v4, v12, v1}, Landroid/support/v4/widget/ap;->a(FF)V
    ...
    invoke-virtual {v1, v4}, Landroid/support/v4/widget/ap;->a(F)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/ap;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/ap;->b(F)V
...
.method private a(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/ap;->setAlpha(I)V
...
.method static synthetic b(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/ap;
    .locals 1
...
.method private b(F)V
    ...
    invoke-virtual {v0, v1, v1}, Landroid/support/v4/widget/ap;->a(FF)V
...
.method private c()V
    ...
    invoke-direct {v0, v1, p0}, Landroid/support/v4/widget/ap;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/ap;

    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/ap;

    invoke-virtual {v0, v3}, Landroid/support/v4/widget/ap;->b(I)V
...
.method private c(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/ap;->getAlpha()I
    ...
    invoke-static {v0}, Landroid/support/v4/view/bw;->r(Landroid/view/View;)F
...
.method static synthetic d(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/by;
    .locals 1

    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/by;
...
.method private setColorViewAlpha(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/ap;->setAlpha(I)V
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    invoke-static {v0}, Landroid/support/v4/view/bw;->z(Landroid/view/View;)Z
...
.method public setOnRefreshListener(Landroid/support/v4/widget/by;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/by;
...
.method public setProgressBackgroundColorSchemeColor(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/ap;->b(I)V
