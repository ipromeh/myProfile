...
# static fields
.field private static final v:Landroid/support/v4/widget/au;

.field private static final w:[I


# instance fields
.field private A:Landroid/support/v4/widget/av;

.field private a:J

.field private final b:Landroid/graphics/Rect;

.field private c:Landroid/support/v4/widget/bj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/NestedScrollView;->v:Landroid/support/v4/widget/au;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Landroid/support/v4/widget/NestedScrollView;->v:Landroid/support/v4/widget/au;
...
.method private a()V
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v4/widget/bj;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bj;
...
.method public final a(II)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bj;

    invoke-virtual {p0}, Landroid/support/v4/widget/NestedScrollView;->getScrollX()I

    move-result v3

    invoke-virtual {v2, v3, v1, v4, v0}, Landroid/support/v4/widget/bj;->a(IIII)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bj;

    invoke-virtual {v0}, Landroid/support/v4/widget/bj;->a()Z
...
.method a(IIIIIIIIZ)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bj;
    ...
    invoke-virtual/range {v1 .. v7}, Landroid/support/v4/widget/bj;->a(IIIIII)Z
...
.method public computeScroll()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bj;->g()Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bj;->b()I

    move-result v1

    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bj;

    invoke-virtual {v2}, Landroid/support/v4/widget/bj;->c()I
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bj;->f()F
...
.method public d(I)V
    ...
    invoke-virtual/range {v0 .. v10}, Landroid/support/v4/widget/bj;->a(IIIIIIIIII)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bj;->a()Z
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v4/widget/bj;->a(IIIIII)Z
...
.method protected onScrollChanged(IIII)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->A:Landroid/support/v4/widget/av;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/v4/widget/av;->a(Landroid/support/v4/widget/NestedScrollView;IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bj;

    invoke-virtual {v2}, Landroid/support/v4/widget/bj;->a()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bj;->h()V
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/support/v4/widget/bj;->a(IIIIII)Z
...
.method public setOnScrollChangeListener(Landroid/support/v4/widget/av;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->A:Landroid/support/v4/widget/av;
