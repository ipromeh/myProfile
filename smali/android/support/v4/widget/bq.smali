...
.method public onAnimationEnd(Landroid/view/animation/Animation;)V
    ...
    invoke-static {v0}, Landroid/support/v4/widget/SwipeRefreshLayout;->b(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/ap;

    move-result-object v0

    invoke-virtual {v0, v2}, Landroid/support/v4/widget/ap;->setAlpha(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/ap;->start()V
    ...
    invoke-static {v0}, Landroid/support/v4/widget/SwipeRefreshLayout;->d(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/by;
    ...
    invoke-interface {v0}, Landroid/support/v4/widget/by;->a()V

    :cond_0
    :goto_0
    iget-object v0, p0, Landroid/support/v4/widget/bq;->a:Landroid/support/v4/widget/SwipeRefreshLayout;

    iget-object v1, p0, Landroid/support/v4/widget/bq;->a:Landroid/support/v4/widget/SwipeRefreshLayout;
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/ap;->stop()V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/bq;->a:Landroid/support/v4/widget/SwipeRefreshLayout;
