...
.field c:Landroid/support/v4/app/as;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field n:Landroid/support/v4/app/au;

.field final synthetic o:Landroid/support/v4/app/at;
...
.method a()V
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/au;->i:Z

    if-eqz v0, :cond_1

    iget-boolean v0, p0, Landroid/support/v4/app/au;->j:Z

    if-eqz v0, :cond_1

    iput-boolean v3, p0, Landroid/support/v4/app/au;->h:Z
    ...
    :cond_1
    iget-boolean v0, p0, Landroid/support/v4/app/au;->h:Z
    ...
    :cond_4
    iget-boolean v0, p0, Landroid/support/v4/app/au;->m:Z
...
.method a(Lcom/abdhoms/myprofile/z;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/au;->o:Landroid/support/v4/app/at;

    invoke-static {v1}, Landroid/support/v4/app/at;->a(Landroid/support/v4/app/at;)Landroid/support/v4/app/w;

    move-result-object v1

    if-eqz v1, :cond_4

    iget-object v0, p0, Landroid/support/v4/app/au;->o:Landroid/support/v4/app/at;

    invoke-static {v0}, Landroid/support/v4/app/at;->a(Landroid/support/v4/app/at;)Landroid/support/v4/app/w;
    ...
    iget-object v2, p0, Landroid/support/v4/app/au;->o:Landroid/support/v4/app/at;

    invoke-static {v2}, Landroid/support/v4/app/at;->a(Landroid/support/v4/app/at;)Landroid/support/v4/app/w;
...
.method public a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget v0, p0, Landroid/support/v4/app/au;->a:I
    ...
    iget-object v0, p0, Landroid/support/v4/app/au;->b:Landroid/os/Bundle;
    ...
    iget-object v0, p0, Landroid/support/v4/app/au;->g:Ljava/lang/Object;
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/au;->k:Z
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/au;->l:Z
...
.method b()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/au;->i:Z

    iget-boolean v0, p0, Landroid/support/v4/app/au;->h:Z

    iput-boolean v0, p0, Landroid/support/v4/app/au;->j:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/v4/app/au;->h:Z

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v4/app/au;->c:Landroid/support/v4/app/as;
...
.method c()V
    ...
    iget-boolean v1, p0, Landroid/support/v4/app/au;->j:Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/au;->e()V
...
.method d()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/au;->k:Z
...
.method f()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/au;->l:Z

    iget-boolean v0, p0, Landroid/support/v4/app/au;->f:Z

    iput-boolean v4, p0, Landroid/support/v4/app/au;->f:Z

    iget-object v1, p0, Landroid/support/v4/app/au;->c:Landroid/support/v4/app/as;
    ...
    iget-boolean v1, p0, Landroid/support/v4/app/au;->e:Z
    ...
    iput-object v3, v1, Landroid/support/v4/app/z;->v:Ljava/lang/String;
    ...
    :cond_2
    iput-object v2, p0, Landroid/support/v4/app/au;->c:Landroid/support/v4/app/as;

    iput-object v2, p0, Landroid/support/v4/app/au;->g:Ljava/lang/Object;
