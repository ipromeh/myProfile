...
.field o:Landroid/support/v4/app/w;
...
.method private a(Ljava/lang/RuntimeException;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/z;->o:Landroid/support/v4/app/w;
    ...
    invoke-virtual {v0, v2, v3, v1, v4}, Landroid/support/v4/app/w;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    :try_end_0
...
.method static a(Landroid/view/View;Landroid/view/animation/Animation;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/view/bw;->x(Landroid/view/View;)Z
...
.method private b(Landroid/view/View;Landroid/view/animation/Animation;)V
    ...
    invoke-direct {v1, p1, p2, v0}, Landroid/support/v4/app/ac;-><init>(Landroid/view/View;Landroid/view/animation/Animation;Landroid/view/animation/Animation$AnimationListener;)V
...
.method public a()Landroid/support/v4/app/aj;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/app/e;-><init>(Landroid/support/v4/app/z;)V
...
.method public a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    sget-object v1, Landroid/support/v4/app/af;->a:[I
    ...
    iput-object p0, v4, Landroid/support/v4/app/Fragment;->t:Landroid/support/v4/app/z;

    iget-object v0, p0, Landroid/support/v4/app/z;->o:Landroid/support/v4/app/w;

    iput-object v0, v4, Landroid/support/v4/app/Fragment;->u:Landroid/support/v4/app/w;
...
.method a(IIIZ)V
    ...
    iget-object v0, v1, Landroid/support/v4/app/Fragment;->N:Landroid/support/v4/app/at;
...
.method a(Landroid/os/Parcelable;Ljava/util/List;)V
    ...
    iget-object v5, p0, Landroid/support/v4/app/z;->o:Landroid/support/v4/app/w;

    invoke-virtual {v5}, Landroid/support/v4/app/w;->g()Landroid/content/Context;
    ...
    iget-object v3, p0, Landroid/support/v4/app/z;->o:Landroid/support/v4/app/w;

    iget-object v4, p0, Landroid/support/v4/app/z;->q:Landroid/support/v4/app/Fragment;

    invoke-virtual {v1, v3, v4}, Landroid/support/v4/app/FragmentState;->a(Landroid/support/v4/app/w;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v1, p0}, Landroid/support/v4/app/BackStackState;->a(Landroid/support/v4/app/z;)Landroid/support/v4/app/e;
    ...
    invoke-virtual {p0, v3, v1}, Landroid/support/v4/app/z;->a(ILandroid/support/v4/app/e;)V
...
.method a(Landroid/support/v4/app/Fragment;IIIZ)V
    ...
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->u:Landroid/support/v4/app/w;
    ...
    iget-object v0, v0, Landroid/support/v4/app/Fragment;->v:Landroid/support/v4/app/z;

    :goto_2
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->t:Landroid/support/v4/app/z;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/w;->b(Landroid/support/v4/app/Fragment;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/z;->p:Landroid/support/v4/app/u;

    iget v1, p1, Landroid/support/v4/app/Fragment;->y:I

    invoke-virtual {v0, v1}, Landroid/support/v4/app/u;->a(I)Landroid/view/View;
    ...
    invoke-static {v0}, Landroid/support/v4/app/ba;->a(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-static {v1}, Landroid/support/v4/app/ba;->a(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/w;->a(Landroid/support/v4/app/Fragment;)Z
    ...
    invoke-direct {v2, p0, v1, v0, p1}, Landroid/support/v4/app/ab;-><init>(Landroid/support/v4/app/z;Landroid/view/View;Landroid/view/animation/Animation;Landroid/support/v4/app/Fragment;)V
    ...
    :cond_30
    iput-object v7, p1, Landroid/support/v4/app/Fragment;->u:Landroid/support/v4/app/w;

    iput-object v7, p1, Landroid/support/v4/app/Fragment;->w:Landroid/support/v4/app/Fragment;

    iput-object v7, p1, Landroid/support/v4/app/Fragment;->t:Landroid/support/v4/app/z;

    iput-object v7, p1, Landroid/support/v4/app/Fragment;->v:Landroid/support/v4/app/z;
...
.method public a(Landroid/support/v4/app/w;Landroid/support/v4/app/u;Landroid/support/v4/app/Fragment;)V
    .locals 2
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v4/app/z;->o:Landroid/support/v4/app/w;

    iput-object p2, p0, Landroid/support/v4/app/z;->p:Landroid/support/v4/app/u;
...
.method public a(Ljava/lang/Runnable;Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/w;->h()Landroid/os/Handler;
...
.method e(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/w;->a(Ljava/lang/String;)V
...
.method public g()Z
    ...
    invoke-virtual {v3}, Landroid/support/v4/app/w;->h()Landroid/os/Handler;
    ...
    iget-object v5, v0, Landroid/support/v4/app/Fragment;->N:Landroid/support/v4/app/at;

    if-eqz v5, :cond_3

    iget-object v0, v0, Landroid/support/v4/app/Fragment;->N:Landroid/support/v4/app/at;
...
.method public t()V
    ...
    iput-object v1, p0, Landroid/support/v4/app/z;->o:Landroid/support/v4/app/w;

    iput-object v1, p0, Landroid/support/v4/app/z;->p:Landroid/support/v4/app/u;
...
.method v()Landroid/support/v4/view/am;
    .locals 0
